...
$ervices = $conn->query("SELECT * FROM `service_list` where id in ({$service_ids}) order by `name` asc");
                                        ...
                                        <table class="table table-stripped table-bordered" data-placeholder='true'>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="border-info">
                                                    ...
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Total Payment</th>
                                                    <td class="py-1 px-2 text-right"><?= ($total_payment) ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </fieldset>
